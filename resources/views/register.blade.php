    ...
    <div class="row" style="padding-left: 5px;padding-right: 5px;">
      ...
      <div class="col-md-4" >
        <div class="card" style="border: 1px solid rgb(25 135 84);">
          <div class="card-header" style="font-weight:700;     color: #198754;">New Account</div>
          <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <label style="text-align: center; color:#9b9b9b; font-weight:500; font-size: 14px;">First Name</label>
          ...
          <div class="card-footer">
            <div class="row">
                <div class="col-md-12">
                  <a href="<?= url('/')?>/login">
                    <button class="btn btn-warning" style="font-size:12px; color: #fff; float: left; background-color: #ff6c21;border-color: #ff6c21;">Back To Login</button>
                  </a>
                  <button class="btn btn-success" style="font-size:12px; float: right;">Create</button>
                </div>
            </div>
          </div>
        </div>
